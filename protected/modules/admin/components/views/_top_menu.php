		...
		<?php if(Yii::app()->user->user_group == 3):?>
            ...
            <li>
                <a href="<?php  echo Yii::app()->createUrl("/admin/notifications/index")?>">
                    <span class="meta">
                        <span class="text">Wating <span class="number label label-danger" id="notificationCount"><?php echo Notifications::model()->totalNotifications(Yii::app()->user->id)?></span></span>
                    </span>
                </a>	
            </li>
            <?php endif; ?>
