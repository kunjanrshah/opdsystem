    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <ul class="list-group list-group-tabs">
                <li class="list-group-item active"><a data-toggle="tab" href="#profile"><i class="ico-user2 mr5"></i> Profile</a></li>
                <li class="list-group-item"><a data-toggle="tab" href="#account"><i class="ico-archive2 mr5"></i> Account</a></li>
                <li class="list-group-item"><a data-toggle="tab" href="#security"><i class="ico-shield3 mr5"></i> Security &amp; privacy</a></li>
            ...
            <ul class="list-table">
                <li style="width:70px;">
                    <img width="65px" alt="image" src="image/avatar/avatar7.jpg" class="img-circle img-bordered">
                </li>
                <li class="text-left">
