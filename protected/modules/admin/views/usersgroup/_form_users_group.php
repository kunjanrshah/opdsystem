    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-primary"><i class="ico-users mr5"></i><?php echo!$model->isNewRecord ? common::getTitle("usersgroup/update") : common::getTitle("usersgroup/add"); ?></h4>
            </div>            
                ...
                <div class="row nm">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo $form->error($model, "group_name", array("class" => "parsley-custom-error-message")); ?>
                        </div>
                    </div>
                    <div class="col-md-3"></div>
                </div>
