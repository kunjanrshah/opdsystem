<?php
$deleteRight = common::checkActionAccess("area/delete");
?>
            ...
            <div class="panel panel-primary">
                <div class="panel-toolbar-wrapper pl0 pt5 pb5">
                    <div class="panel-toolbar pl10">
                        <div class="pull-left">
                            <span class="semibold">&nbsp;&nbsp;<?php echo common::getTitle("area/index"); ?></span>  
                        </div>
                    </div>
                    <div class="panel-toolbar text-right">
                        <?php
                        if (common::checkActionAccess("area/add")) :
                            echo CHtml::Link(common::getTitle("area/add") . ' <i class="ico-plus"></i>', array("area/add"), array(
                                "title" => common::getTitle("area/add"),
                                "data-placement" => "bottom",
                                "rel" => "tooltip",
                                "class" => "btn btn-sm btn-default addUpdateRecord",
                                "data-original-title" => common::getTitle("area/add")
                            ));
                        endif;

                        if ($deleteRight) :
                            echo CHtml::Link('<i class="ico-remove3"></i>', array("/admin/area/delete"), array("class" => "ml5 btn btn-sm btn-danger deleteRecord multipleDelete"));
                        endif;
                        ?>
                    </div>
                </div>
                ...
                <div class="table-responsive panel-collapse pull out">                  
                    <?php
                    $updateRight = common::checkActionAccess("area/index");
                    $deleteRight = common::checkActionAccess("area/delete");
                            ...
                            array(
                                ...
                                "buttons" => array(
                                    "updateRecord" => array(
                                        ...
                                        "options" => array("class" => "addUpdateRecord mr5", "title" => common::getTitle("area/update")),
                                    ...
                                    "deleteRecord" => array(
                                        ...
                                        "options" => array("class" => "deleteRecord text-danger mr5", "title" => common::getTitle("area/delete")),
