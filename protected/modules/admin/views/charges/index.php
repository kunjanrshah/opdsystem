<?php
$deleteRight = common::checkActionAccess("charges/delete");
?><!-- START Template Container -->
<div class="container-fluid">
    <!-- START row -->
    <?php $this->renderPartial("/layouts/_message"); ?>
    <?php $this->renderPartial("application.modules.admin.views.common._search", array("field"=>"charge_title", "id"=>"users-group-grid", "model" => $model));?>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-toolbar-wrapper pl0 pt5 pb5">
                    <div class="panel-toolbar pl10">
                        <div class="pull-left">
                            <span class="semibold">&nbsp;&nbsp;<?php echo common::getTitle("charges/index"); ?></span>  
                        </div>
                    </div>
                    <div class="panel-toolbar text-right">
                        <?php
                        if (common::checkActionAccess("charges/add")) :
                            echo CHtml::Link(common::getTitle("charges/add") . ' <i class="ico-plus"></i>', array("charges/add"), array(
                                "title" => common::getTitle("charges/add"),
                                "data-placement" => "bottom",
                                "rel" => "tooltip",
                                "class" => "btn btn-sm btn-default addUpdateRecord",
                                "data-original-title" => common::getTitle("charges/add")
                            ));
                        endif;

                        if ($deleteRight) :
                            echo CHtml::Link('<i class="ico-remove3"></i>', array("/admin/charges/delete"), array("class" => "ml5 btn btn-sm btn-danger deleteRecord multipleDelete"));
                        endif;
                        ?>
                    </div>
                </div>
                ...
                <div class="table-responsive panel-collapse pull out">                  
                    <?php
                    $updateRight = common::checkActionAccess("charges/index");
                    $deleteRight = common::checkActionAccess("charges/delete");
                    $permissionRight = common::checkActionAccess("charges/permissions");
                    ...
                    $this->widget("zii.widgets.grid.CGridView", array(
                        ...
                        "columns" => array(
                            ...
                            array(
                                "name" => "amount",
                                "value" => '$data->amount',
                                "htmlOptions" => array("width" => "10%", "class" => "text-right"),
                            ),
                            array(
                                "class" => "CButtonColumn",
                                "header" => "Action",
                                ...
                                "buttons" => array(
                                    "updateRecord" => array(
                                        ...
                                        "imageUrl" => false,
                                        "url" => 'Yii::app()->createUrl("/admin/charges/update", array("id"=>$data->id))',
                                        "options" => array("class" => "addUpdateRecord mr5", "title" => common::getTitle("charges/update")),
                                        "visible" => ($updateRight) ? 'true' : 'false',
                                    ),
                                    "deleteRecord" => array(
                                        "label" => '<i class="icon ico-trash"></i> ' . common::translateText("DELETE_BTN_TEXT"),
                                        "imageUrl" => false,
                                        "url" => 'Yii::app()->createUrl("/admin/charges/delete", array("id"=>$data->id))',
                                        "options" => array("class" => "deleteRecord text-danger mr5", "title" => common::getTitle("charges/delete")),
