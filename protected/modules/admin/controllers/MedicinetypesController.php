...
class MedicinetypesController extends Controller {
    ...
    public function actionAdd() {
        if (Yii::app()->request->isPostRequest) {
            ...
            $this->performAjaxValidation($model, "form-medicine-types");
    ...
    public function actionUpdate($id) {
        if (Yii::app()->request->isPostRequest) {
            ...
            Yii::app()->clientscript->scriptMap['jquery.min.js'] = FALSE;
            Yii::app()->clientscript->scriptMap['jquery.js'] = FALSE;
            $model = $this->loadModel($id, "MedicineTypes");
            // Uncomment the following line if AJAX validation is needed
            $this->performAjaxValidation($model, "form-medicine-types");
    ...
    public function getOptions($selected_id = null) {
        $model = MedicineTypes::model()->findAll();
        ...
        if ($model): foreach ($model as $value):
                ...
                $option .= CHtml::tag('option', array('value' => $value->id, 'selected' => $selected), CHtml::encode($value->name), true);
            endforeach;
        endif;
        return $option;
    }
