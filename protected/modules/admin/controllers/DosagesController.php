...
class DosagesController extends Controller {
    ...
    public function actionIndex() {
        $model = new DosagesMaster("search");
    ...
    public function actionAdd() {
        if (Yii::app()->request->isPostRequest) {
            $model = new DosagesMaster();
            // Uncomment the following line if AJAX validation is needed
            $this->performAjaxValidation($model, "form-dosage");

            if (isset($_POST['DosagesMaster'])) {
                $model->attributes = $_POST['DosagesMaster'];
                if ($model->validate()) {
                ...
                $this->redirect(array("/admin/Dosages"));
            }

            $outputJs = Yii::app()->request->isAjaxRequest;
            $this->renderPartial('_form_dosage', array('model' => $model), false, $outputJs);
        } else
    ...
    public function actionUpdate($id) {
        if (Yii::app()->request->isPostRequest) {
            $model = $this->loadModel($id, "DosagesMaster");
            // Uncomment the following line if AJAX validation is needed
            $this->performAjaxValidation($model, "form-dosage");
